...
public class ProgramEdit_SD {
	...
	@When("Admin clicks {string} on the navigation bar edit")
	public void admin_clicks_on_the_navigation_bar_edit(String menuoption) {
		db.clickProgramMenu();
	}
	...
	@Then("Admin should see window title  {string}")
	public void admin_should_see_window_title (String string) {
